...
class DataArguments:
    ...
    sample_range: Optional[str] = field(
        default=None,
        metadata={"help": "The range of dataset to use for training. Use commas to separate multiple datasets."},
    )
    ...
    def __post_init__(self):
        ...
        self.sample_range = split_arg(self.sample_range)
        self.sample_range = [int(item) for item in self.sample_range] if self.sample_range is not None else None
