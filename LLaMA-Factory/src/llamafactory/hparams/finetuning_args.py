...
class FreezeArguments:
    ...
    freefreeze_frozen_modules: Optional[str] = field(
        default=None,
        metadata={
            "help": (
                "Name(s) of modules to be set as untrainable "
                "for freefreeze (partial-parameter) fine-tuning. "
                "Use commas to separate multiple modules."
            )
        },
    )
    freefreeze_trainable_modules: Optional[str] = field(
        default=None,
        metadata={
            "help": (
                "Name(s) of modules to be set as untrainable "
...
class LoraArguments:
    ...
    split_method: Optional[str] = field(
        default="jieba",
        metadata={"help": "Word splitting method used when evaluation."},
    )
...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    finetuning_type: Literal["lora", "freeze", "full", "freefreeze"] = field(
        default="lora",
    ...
    compute_classwise_accuracy: bool = field(
        default=False,
        metadata={"help": "Whether or not to compute the token-level class-wise accuracy at evaluation."},
    )
    class_set: str = field(
        default="",
        metadata={"help": "Class set used for class-wise accuracy computation."},
    )
    ...
    def __post_init__(self):
        ...
        self.freefreeze_frozen_modules: Optional[List[str]] = split_arg(self.freefreeze_frozen_modules)
        self.freefreeze_trainable_modules: Optional[List[str]] = split_arg(self.freefreeze_trainable_modules)
        self.class_set: Optional[List[str]] = split_arg(self.class_set)
        ...
        assert self.finetuning_type in ["lora", "freeze", "full","freefreeze"], "Invalid fine-tuning method."
